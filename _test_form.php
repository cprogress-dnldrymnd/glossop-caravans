...
<head>
    ...
    <script type="text/javascript">
        ...
        window._wpemojiSettings = {
            ...
            "svgExt": ".svg",
            "source": {
                "concatemoji": "https:\/\/newglossopacaravans.theprogressteam.co.uk\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.8.1"
            }
        };
    ...
    <link rel="stylesheet" id="wp-block-library-css" href="https://newglossopacaravans.theprogressteam.co.uk/wp-includes/css/dist/block-library/style.min.css?ver=6.8.1" type="text/css" media="all">
  ...
  \*************************************************************************************************************************************************************************************************************************************************************************************************/
        ...
        .wp-block-aab-horizontal-accordion .wp-block-aab-horizontal-accordion-item>.aahb_accordion_head>.aahb_accordion_heading .aahb_heading,
        .wp-block-aab-horizontal-accordion .wp-block-aab-horizontal-accordion-item>.aahb_accordion_head>.aahb_accordion_heading .aahb_subheading {
            margin: 0;
            padding: 0;
            line-height: 28px;
            font-size: 16px;
        ...
        .wp-block-aab-horizontal-accordion .wp-block-aab-horizontal-accordion-item>.aahb_accordion_body>.block-editor-inner-blocks>.block-editor-block-list__layout,
        .wp-block-aab-horizontal-accordion .wp-block-aab-horizontal-accordion-item>.aahb_accordion_body {
            width: 500px;
            filter: blur(5px);
            transition-duration: 100ms;
        }

        .wp-block-aab-horizontal-accordion .wp-block-aab-horizontal-accordion-item>.aahb_accordion_body>.block-editor-inner-blocks>.block-editor-block-list__layout .wp-block-image img[alt=aahb-trees-water],
        .wp-block-aab-horizontal-accordion .wp-block-aab-horizontal-accordion-item>.aahb_accordion_body .wp-block-image img[alt=aahb-trees-water] {
            border-radius: 10px;
        }
        ...
        .wp-block-aab-horizontal-accordion .wp-block-aab-horizontal-accordion-item.active>.aahb_accordion_body>.block-editor-inner-blocks>.block-editor-block-list__layout,
        .wp-block-aab-horizontal-accordion .wp-block-aab-horizontal-accordion-item.active>.aahb_accordion_body {
            filter: blur(0);
            max-width: 500px;
        }
    ...
    <link rel="stylesheet" id="bicb-carousel-style-css" href="https://newglossopacaravans.theprogressteam.co.uk/wp-content/plugins/b-carousel-block/build/view.css?ver=6.8.1" type="text/css" media="all">
    <link rel="stylesheet" id="dashicons-css" href="https://newglossopacaravans.theprogressteam.co.uk/wp-includes/css/dashicons.min.css?ver=6.8.1" type="text/css" media="all">
    <style id="global-styles-inline-css" type="text/css">
        :root {
            ...
            --wp--preset--color--text: #202020;
            --wp--preset--color--white-theme: #ffffff;
            --wp--preset--color--orange-color: #ff681e;
            --wp--preset--color--orange-color-2: #FF980E;
            --wp--preset--color--orange-color-3: #FF5251;
            --wp--preset--color--green: #45c324;
            --wp--preset--color--yellow: #FFC831;
            --wp--preset--color--teal: #009BA5;
            --wp--preset--color--blue: #00BCE2;
            --wp--preset--color--dark: #505050;
            --wp--preset--color--gray: #CCCCCC;
            --wp--preset--color--lightgray-1: #f5f5f5;
            --wp--preset--color--lightgray-2: #F2F2F2;
            --wp--preset--color--lightgray-3: #f5f5f5;
            --wp--preset--color--lightgray-4: #F6F6F6;
            --wp--preset--color--red: #CC0909;
        ...
        .has-white-theme-color {
            color: var(--wp--preset--color--white-theme) !important;
        }

        .has-orange-color-color {
            color: var(--wp--preset--color--orange-color) !important;
        }

        .has-orange-color-2-color {
            color: var(--wp--preset--color--orange-color-2) !important;
        }

        .has-orange-color-3-color {
            color: var(--wp--preset--color--orange-color-3) !important;
        }
        ...
        .has-lightgray-1-color {
            color: var(--wp--preset--color--lightgray-1) !important;
        }

        .has-lightgray-2-color {
            color: var(--wp--preset--color--lightgray-2) !important;
        }

        .has-lightgray-3-color {
            color: var(--wp--preset--color--lightgray-3) !important;
        }

        .has-lightgray-4-color {
            color: var(--wp--preset--color--lightgray-4) !important;
        }
        ...
        .has-white-theme-background-color {
            background-color: var(--wp--preset--color--white-theme) !important;
        }

        .has-orange-color-background-color {
            background-color: var(--wp--preset--color--orange-color) !important;
        }

        .has-orange-color-2-background-color {
            background-color: var(--wp--preset--color--orange-color-2) !important;
        }

        .has-orange-color-3-background-color {
            background-color: var(--wp--preset--color--orange-color-3) !important;
        }
        ...
        .has-lightgray-1-background-color {
            background-color: var(--wp--preset--color--lightgray-1) !important;
        }

        .has-lightgray-2-background-color {
            background-color: var(--wp--preset--color--lightgray-2) !important;
        }

        .has-lightgray-3-background-color {
            background-color: var(--wp--preset--color--lightgray-3) !important;
        }

        .has-lightgray-4-background-color {
            background-color: var(--wp--preset--color--lightgray-4) !important;
        }
        ...
        .has-white-theme-border-color {
            border-color: var(--wp--preset--color--white-theme) !important;
        }

        .has-orange-color-border-color {
            border-color: var(--wp--preset--color--orange-color) !important;
        }

        .has-orange-color-2-border-color {
            border-color: var(--wp--preset--color--orange-color-2) !important;
        }

        .has-orange-color-3-border-color {
            border-color: var(--wp--preset--color--orange-color-3) !important;
        }
        ...
        .has-lightgray-1-border-color {
            border-color: var(--wp--preset--color--lightgray-1) !important;
        }

        .has-lightgray-2-border-color {
            border-color: var(--wp--preset--color--lightgray-2) !important;
        }

        .has-lightgray-3-border-color {
            border-color: var(--wp--preset--color--lightgray-3) !important;
        }

        .has-lightgray-4-border-color {
            border-color: var(--wp--preset--color--lightgray-4) !important;
        }
    ...
    <link rel="stylesheet" id="contact-form-7-css" href="https://newglossopacaravans.theprogressteam.co.uk/wp-content/plugins/contact-form-7/includes/css/styles.css?ver=6.0.6" type="text/css" media="all">
    <link rel="stylesheet" id="simply-gallery-block-frontend-css" href="https://newglossopacaravans.theprogressteam.co.uk/wp-content/plugins/simply-gallery-block/blocks/pgc_sgb.min.style.css?ver=3.2.6" type="text/css" media="all">
    <link rel="stylesheet" id="fancybox-css" href="https://newglossopacaravans.theprogressteam.co.uk/wp-content/themes/glossop-caravans/assets/vendors/fancybox/css/fancybox.css?ver=6.8.1" type="text/css" media="all">
    <link rel="stylesheet" id="style-css" href="https://newglossopacaravans.theprogressteam.co.uk/wp-content/themes/glossop-caravans/style.css?ver=6.8.1" type="text/css" media="all">
    <script type="text/javascript" id="jquery-core-js-extra">
        /* <![CDATA[ */
        var aagb_local_object = {
            "ajax_url": "https:\/\/newglossopacaravans.theprogressteam.co.uk\/wp-admin\/admin-ajax.php",
            "nonce": "9c882d0aea",
            "licensing": "",
            "assets": "https:\/\/newglossopacaravans.theprogressteam.co.uk\/wp-content\/plugins\/advanced-accordion-block\/assets\/"
        };
        /* ]]> */
    </script>
    <script type="text/javascript" src="https://newglossopacaravans.theprogressteam.co.uk/wp-includes/js/jquery/jquery.min.js?ver=3.7.1" id="jquery-core-js"></script>
    <script type="text/javascript" src="https://newglossopacaravans.theprogressteam.co.uk/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.4.1" id="jquery-migrate-js"></script>
    <script type="text/javascript" src="https://newglossopacaravans.theprogressteam.co.uk/wp-content/themes/glossop-caravans/assets/vendors/bootstrap/dist/js/bootstrap.min.js?ver=6.8.1" id="bootstrap-js"></script>
    <script type="text/javascript" src="https://newglossopacaravans.theprogressteam.co.uk/wp-content/themes/glossop-caravans/assets/vendors/swiper/js/swiper-bundle.min.js?ver=6.8.1" id="swiper-js"></script>
    <script type="text/javascript" src="https://newglossopacaravans.theprogressteam.co.uk/wp-content/themes/glossop-caravans/assets/vendors/fancybox/js/fancybox.umd.js?ver=6.8.1" id="fancybox-js"></script>
    <script type="text/javascript" src="https://newglossopacaravans.theprogressteam.co.uk/wp-content/themes/glossop-caravans/assets/javascripts/main.js?ver=6.8.1" id="main-js"></script>
    <link rel="https://api.w.org/" href="https://newglossopacaravans.theprogressteam.co.uk/wp-json/">
    <link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://newglossopacaravans.theprogressteam.co.uk/xmlrpc.php?rsd">
    ...
    <link rel="icon" href="https://newglossopacaravans.theprogressteam.co.uk/wp-content/uploads/2025/05/glossop-logo-150x86.png" sizes="32x32">
    <link rel="icon" href="https://newglossopacaravans.theprogressteam.co.uk/wp-content/uploads/2025/05/glossop-logo.png" sizes="192x192">
    <link rel="apple-touch-icon" href="https://newglossopacaravans.theprogressteam.co.uk/wp-content/uploads/2025/05/glossop-logo.png">
    <meta name="msapplication-TileImage" content="https://newglossopacaravans.theprogressteam.co.uk/wp-content/uploads/2025/05/glossop-logo.png">
    <style type="text/css" id="wp-custom-css">
        ...
        .now-on-display-box.now-on-display-box {
            position: static !important;
            border-radius: 0;
        }

        .listing-grid-item__top-position-relative .listing-grid--gallery+.now-on-display-box {
            position: absolute !important;
        }
    </style>

    <script src="https://newglossopacaravans.theprogressteam.co.uk/wp-includes/js/wp-emoji-release.min.js?ver=6.8.1" defer=""></script>
    <style>
...
<body style="--mega-menu-height: nullpx; --header-height: undefinedpx; --header-inner-height: undefinedpx;" class="">
    <div class="wpcf7 js" id="wpcf7-f2550-o1" lang="en-US" dir="ltr" data-wpcf7-id="2550">
        <div class="screen-reader-response">
            <p role="status" aria-live="polite" aria-atomic="true">One or more fields have an error. Please check and try again.</p>
            <ul>
                <li id="wpcf7-f2550-o1-ve-Full_Name">Please fill out this field.</li>
                <li id="wpcf7-f2550-o1-ve-Email">Please fill out this field.</li>
                <li id="wpcf7-f2550-o1-ve-Telephone">Please fill out this field.</li>
                <li id="wpcf7-f2550-o1-ve-enquiry">Please fill out this field.</li>
            </ul>
        </div>
        <form action="/_header_footer.php#wpcf7-f2550-o1" method="post" class="wpcf7-form invalid" aria-label="Contact form" novalidate="novalidate" data-status="invalid">
            ...
            <div class="row g-3">
                <div class="col-lg-6">
                    <div class="form-control-holder">
                        <p><label class="fw-semibold w-100"><span class="mb-2 d-block">Enquiry Type</span><br>
                                <span class="wpcf7-form-control-wrap" data-name="Enquiry_Type"><select class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required form-control background-light-gray-4 border-0" aria-required="true" aria-invalid="false" name="Enquiry_Type">
                ...
                <div class="col-lg-6">
                    <div class="form-control-holder">
                        <p><label class="fw-semibold w-100"><span class="mb-2 d-block">Full Name:</span><br>
                                <span class="wpcf7-form-control-wrap" data-name="Full_Name"><input size="40" maxlength="400" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control background-light-gray-4 border-0 wpcf7-not-valid" aria-required="true" aria-invalid="true" value="" type="text" name="Full_Name" aria-describedby="wpcf7-f2550-o1-ve-Full_Name"><span class="wpcf7-not-valid-tip" aria-hidden="true">Please fill out this field.</span></span><br>
                            </label>
                        </p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-control-holder">
                        <p><label class="fw-semibold w-100"><span class="mb-2 d-block">Email:</span><br>
                                <span class="wpcf7-form-control-wrap" data-name="Email"><input size="40" maxlength="400" class="wpcf7-form-control wpcf7-email wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-email form-control background-light-gray-4 border-0 wpcf7-not-valid" aria-required="true" aria-invalid="true" value="" type="email" name="Email" aria-describedby="wpcf7-f2550-o1-ve-Email"><span class="wpcf7-not-valid-tip" aria-hidden="true">Please fill out this field.</span></span><br>
                            </label>
                        </p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-control-holder">
                        <p><label class="fw-semibold w-100"><span class="mb-2 d-block">Telephone:</span><br>
                                <span class="wpcf7-form-control-wrap" data-name="Telephone"><input size="40" maxlength="400" class="wpcf7-form-control wpcf7-tel wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-tel form-control background-light-gray-4 border-0 wpcf7-not-valid" aria-required="true" aria-invalid="true" value="" type="tel" name="Telephone" aria-describedby="wpcf7-f2550-o1-ve-Telephone"><span class="wpcf7-not-valid-tip" aria-hidden="true">Please fill out this field.</span></span><br>
                            </label>
                        </p>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-control-holder">
                        <p><label class="fw-semibold w-100"><span class="mb-2 d-block">Enquiry</span><br>
                                <span class="wpcf7-form-control-wrap" data-name="enquiry"><textarea cols="10" rows="2" maxlength="2000" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required form-control background-light-gray-4 border-0 wpcf7-not-valid" aria-required="true" aria-invalid="true" name="enquiry" aria-describedby="wpcf7-f2550-o1-ve-enquiry"></textarea><span class="wpcf7-not-valid-tip" aria-hidden="true">Please fill out this field.</span></span><br>
                            </label>
                        </p>
                    </div>
                </div>
                <div class="col-lg-12">
                    <p><span class="wpcf7-form-control-wrap" data-name="acceptance-118"><span class="wpcf7-form-control wpcf7-acceptance optional"><span class="wpcf7-list-item"><label><input type="checkbox" name="acceptance-118" value="1" aria-invalid="false"><span class="wpcf7-list-item-label">I accept the Terms &amp; Conditions and Privacy Policy</span></label></span></span></span>
                    </p>
                </div>
                <div class="col-lg-12">
                    <p><input class="wpcf7-form-control wpcf7-submit has-spinner btn btn-primary btn-lg w-100 btn-hover-bordered text-hover-orange" type="submit" value="Submit Enquiry"><span class="wpcf7-spinner"></span>
                    </p>
                </div>
            </div>
    ...
    <script type="text/javascript" src="https://newglossopacaravans.theprogressteam.co.uk/wp-includes/js/dist/hooks.min.js?ver=4d63a3d491d11ffd8ac6" id="wp-hooks-js"></script>
    <script type="text/javascript" src="https://newglossopacaravans.theprogressteam.co.uk/wp-includes/js/dist/i18n.min.js?ver=5e580eb46a90c2b997e6" id="wp-i18n-js"></script>
    ...
    <script type="text/javascript" src="https://newglossopacaravans.theprogressteam.co.uk/wp-content/plugins/contact-form-7/includes/swv/js/index.js?ver=6.0.6" id="swv-js"></script>
    <script type="text/javascript" id="contact-form-7-js-before">
        /* <![CDATA[ */
        var wpcf7 = {
            "api": {
                "root": "https:\/\/newglossopacaravans.theprogressteam.co.uk\/wp-json\/",
                "namespace": "contact-form-7\/v1"
            }
        };
        /* ]]> */
    </script>
    <script type="text/javascript" src="https://newglossopacaravans.theprogressteam.co.uk/wp-content/plugins/contact-form-7/includes/js/index.js?ver=6.0.6" id="contact-form-7-js"></script>
    <div id="loom-companion-mv3" ext-id="liecbddmkiiihnedobmlmillhodjkdmb">
        <div id="shadow-host-companion"></div>
    </div>
</body><g7ac3d74c-60d9-4f72-afdd-916631bf39cd></g7ac3d74c-60d9-4f72-afdd-916631bf39cd>
