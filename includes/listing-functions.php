...
function listing__key_information_v2()
{
    ...
    <ul
        class="icon-list mb-0 icon-list-v2 d-flex list-inline align-items-center justify-content-end fw-semibold flex-wrap fs-18">
        <li class="border-bottom"> <?= get__theme_images('berths.svg') ?>
            <span>
                <span>Berth</span>
                <span>6</span>
            </span>
        </li>
        <li class="border-bottom"><?= get__theme_images('year.svg') ?>
            <span>
        ...
        <li class="border-bottom"><?= get__theme_images('kg.svg') ?>
            <span>
                <span>MTPLM</span>
                <span>1630kg</span>
            </span>
        </li>
        <li class="border-bottom"><?= get__theme_images('awning-size.svg') ?>
            <span>
                <span>Awning Size</span>
                <span>10.52m</span>
            </span>
        </li>
        <li class="border-bottom"><?= get__theme_images('dimensions.svg') ?>
            <span>
